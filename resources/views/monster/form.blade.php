@if(Route::currentRouteAction() == 'App\Http\Controllers\MonsterController@edit')
  {!! Form::model($monster, ['route' => ['monster.update', $monster->id], 'class' => 'ui form']) !!}
@elseif(Route::currentRouteAction() == 'App\Http\Controllers\MonsterController@create')
  {!! Form::open(['route' => 'monster.store', 'class' => 'ui form']) !!}
@else
  {!! Form::model($monster, ['route' => ['monster.store'], 'class' => 'ui form']) !!}
@endif
  ...
  @if(Request::is('monster/fork/*'))
    <input type="hidden" name="fork_id" value="{{ $monster->id }}">
  @endif
  ...
  <div class="ui active basic tab segment"  data-tab="first">
    ...
    <div class="two fields">
       <div class="required field">
        ...
        {{ Form::select('type[]', CreatureHelper::getTypes(), null,['class' => 'ui compact dropdown', 'multiple'=>'true', 'placeholder'=>'None']) }}
      </div>

      <div class="field">
        {{ Form::label('size','Size') }}
        {{ Form::select('size', CreatureHelper::getSizes(), isset($monster->size) ? $monster->size:'Medium',['class' => 'ui compact dropdown']) }}
      </div>
    </div>
    ...
    <div class="four fields">
      <div class="field">
        {{ Form::label('AC', 'AC') }}
        {{ Form::text('AC',isset($monster->AC) ? $monster->AC:'10') }}
      </div>
      <div class="required field">
        {{ Form::label('hit_dice_amount', 'Hit Dice Amount') }}
        {{ Form::text('hit_dice_amount',isset($monster->hit_dice_amount) ? $monster->hit_dice_amount:'5') }}
      </div>
      <div class="field">
        {{ Form::label('hit_dice_size', 'Hit Dice Size') }}
        {{ Form::text('hit_dice_size',isset($monster->hit_dice_size) ? $monster->hit_dice_size:'6',['readonly'=>'readonly', 'class'=> 'ui disabled input']) }}
      </div>
      <div class="field">
        {{ Form::label('HP') }}
    ...
    <div class="six fields">
      <div class="field">
        ...
        {{ Form::selectRange('strength', 1, 30, isset($monster->strength) ? $monster->strength:'10',['class'=>'ui compact dropdown']) }}
      </div>
      <div class="field">
        {{ Form::label('dexterity', 'Dexterity') }}
        {{ Form::selectRange('dexterity', 1, 30, isset($monster->dexterity) ? $monster->dexterity:'10',['class'=>'ui compact dropdown']) }}
      </div>
      <div class="field">
        {{ Form::label('constitution', 'Constitution') }}
        {{ Form::selectRange('constitution', 1, 30, isset($monster->constitution) ? $monster->constitution:'10',['class'=>'ui compact dropdown']) }}
      </div>
      <div class="field">
        {{ Form::label('intelligence', 'Intelligence') }}
        {{ Form::selectRange('intelligence', 1, 30, isset($monster->intelligence) ? $monster->intelligence:'10',['class'=>'ui compact dropdown']) }}
      </div>
      <div class="field">
        {{ Form::label('wisdom', 'Wisdom') }}
        {{ Form::selectRange('wisdom', 1, 30, isset($monster->wisdom) ? $monster->wisdom:'10',['class'=>'ui compact dropdown']) }}
      </div>
      <div class="field">
        {{ Form::label('charisma', 'Charisma') }}
        {{ Form::selectRange('charisma', 1, 30, isset($monster->charisma) ? $monster->charisma:'10',['class'=>'ui compact dropdown']) }}
      </div>
    </div>
    ...
    <div class="five fields">
      <div class="field">
        ...
        {{ Form::text('speed',isset($monster->speed) ? $monster->speed:'30') }}
      </div>
      <div class="field">
  ...
  <div class="ui basic tab segment"  data-tab="third">
    ...
    <div class="field">
      ...
      @else
        {{ Form::select('spells_at_will[]', $spells, isset($monster->spells) ? $monster->spells->where('pivot.level', 'at_will')->pluck('id')->toArray():null,['class' => 'ui fluid search dropdown', 'multiple'=>'true']) }}
      @endif
    </div>
    <div class="field">
      ...
      @else
        {{ Form::select('spells_one[]', $spells, isset($monster->spells) ? $monster->spells->where('pivot.level', 'one')->pluck('id')->toArray():null,['class' => 'ui fluid search dropdown', 'multiple'=>'true']) }}
      @endif
    </div>
    <div class="field">
      ...
      @else
        {{ Form::select('spells_two[]', $spells, isset($monster->spells) ? $monster->spells->where('pivot.level', 'two')->pluck('id')->toArray():null,['class' => 'ui fluid search dropdown', 'multiple'=>'true']) }}
      @endif
    </div>
    <div class="field">
      ...
      @else
        {{ Form::select('spells_three[]', $spells, isset($monster->spells) ? $monster->spells->where('pivot.level', 'three')->pluck('id')->toArray():null,['class' => 'ui fluid search dropdown', 'multiple'=>'true']) }}
      @endif
    </div>
    ...
    <div id="ability-container">
      @if(old('abilities'))
        ...
        @endforeach
      @elseif(isset($monster) && $monster->abilities)
    ...
    <div id="action-container">
     @if(old('actions'))
        ...
        @endforeach
      @elseif(isset($monster) && $monster->actions)

...
<div class="ui container">
	<div class="section">
	<p>Permission to copy, modify and distribute the files collectively known
	as the System Reference Document 5.1 (“SRD5”) is granted solely through
	the use of the Open Gaming License, Version 1.0a.</p>
	<p>This material is being released using the Open Gaming License Version
	1.0a and you should read and understand the terms of that license before
	using this material.</p>
	...
	itself.</p>
	<p>The following items are designated Product Identity, as defined in
	...
	illithid, umber hulk, yuan-ti.</p>
	<p>All of the rest of the SRD5 is Open Game Content as described in Section
	1(d) of the License.</p>
	...
	Reserved.</p>
	<ol>
	<li><p>Definitions: (a)”Contributors” means the copyright and/or trademark
	...
	the licensee in terms of this agreement.</p>
	</li>
	<li><p>The License: This License applies to any Open Game Content that
	...
	Open Game Content distributed using this License.</p>
	</li>
	<li><p>Offer and Acceptance: By Using the Open Game Content You indicate
	Your acceptance of the terms of this License.</p>
	</li>
	<li><p>Grant and Consideration: In consideration for agreeing to use this
	License, the Contributors grant You a perpetual, worldwide,
	royalty-free, non-exclusive license with the exact terms of this
	License to Use, the Open Game Content.</p>
	</li>
	<li><p>Representation of Authority to Contribute: If You are contributing
	original material as Open Game Content, You represent that Your
	Contributions are Your original creation and/or You have sufficient
	rights to grant the rights conveyed by this License.</p>
	</li>
	<li><p>Notice of License Copyright: You must update the COPYRIGHT NOTICE
	...
	Open Game Content you Distribute.</p>
	</li>
	<li><p>Use of Product Identity: You agree not to Use any Product Identity,
	...
	rights, title and interest in and to that Product Identity.</p>
	</li>
	<li><p>Identification: If you distribute Open Game Content You must clearly
	indicate which portions of the work that you are distributing are
	Open Game Content.</p>
	</li>
	<li><p>Updating the License: Wizards or its designated Agents may publish
	...
	originally distributed under any version of this License.</p>
	</li>
	<li><p>Copy of this License: You MUST include a copy of this License with
	every copy of the Open Game Content You Distribute.</p>
	</li>
	<li><p>Use of Contributor Credits: You may not market or advertise the Open
	Game Content using the name of any Contributor unless You have
	written permission from the Contributor to do so.</p>
	</li>
	<li><p>Inability to Comply: If it is impossible for You to comply with any
	...
	<li><p>Termination: This License will terminate automatically if You fail
	...
	<li><p>Reformation: If any provision of this License is held to be
	unenforceable, such provision shall be reformed only to the extent
	necessary to make it enforceable.</p>
	</li>
	<li><p>COPYRIGHT NOTICE</p>
	<p>Open Game License v 1.0a Copyright 2000, Wizards of the Coast, LLC.</p>
	<p>System Reference Document 5.1 Copyright 2016, Wizards of the Coast,
	...
	Gygax and Dave Arneson.</p>
	</li>
	</ol>
	<p>END OF LICENSE</p>
	<p>If you note any errors in this document, please let us know by emailing
	<a href="mailto:askdnd%40wizards.com">askdnd@wizards.com.</a></p>
	</div>
</div>

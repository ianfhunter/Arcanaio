...
function like(event) {
  ...
  var like_count = parseInt($(this).find('.like-counter').text());

  $(this).children('span').html("<i class='asterisk loading icon'></i>");
  ...
  $(this).queue(function(){
      ...
      $.ajax({
          ...
          success: function (response) {
              ...
              $(this).find('.like-counter').text(like_count);                           
          } 
      });
...
$(function() {
  ...
  $("#notifications-button").click(readNotifications);

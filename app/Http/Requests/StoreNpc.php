...
class StoreNpc extends FormRequest {
	/**
	...
	public function rules() {
		return [
			'name' => 'required|string|unique:npcs,name,NULL,id,deleted_at,NULL|max:140',
			'ideal' => 'string|max:1000',
			'bond' => 'string|max:1000',
			'flaw' => 'string|max:1000',
			'CR' => 'required|numeric',
			'race' => 'string',
